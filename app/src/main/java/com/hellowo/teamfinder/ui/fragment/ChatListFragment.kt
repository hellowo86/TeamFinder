...
class ChatListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapterMy = MyChatListAdapter(activity!!, MyChat.value!!) {
        ...
        MyChat.observe(this, Observer { adapterMy.notifyDataSetChanged() })
        MyChat.loading.observe(this, Observer { progressBar.visibility = if(it as Boolean) View.VISIBLE else View.GONE })
    }
}
