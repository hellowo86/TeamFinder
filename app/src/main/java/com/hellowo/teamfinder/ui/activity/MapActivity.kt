...
import com.hellowo.teamfinder.ui.fragment.ChoiceFragment
import com.hellowo.teamfinder.ui.fragment.FindFragment
import com.hellowo.teamfinder.ui.fragment.ProfileFragment
...
class MapActivity : AppCompatActivity(), OnMapReadyCallback {
                ...
                FirebaseDatabase.getInstance().reference.child(KEY_USERS).child(MyChatLiveData.currentUserId)
                        ...
                        .addListenerForSingleValueEvent(object : ValueEventListener {
                            ...
                            override fun onDataChange(p0: DataSnapshot?) {
                                ...
                                val intent = Intent(this@MapActivity, ChatingActivity::class.java)
    ...
    val permissionlistener = object : PermissionListener {
        ...
        override fun onPermissionGranted() {
            ...
            CurrentLocation.setCurrentLocation(this@MapActivity) { setLocation(it) }
        }
